...
def banner():
	clear()
	alvino_xy(f'''\t{asu}                                               
\tAm Toola Drustkrawa Lalayan MALA SHAFIQ&BLND👥
\tAm Toola Vipea Wadafroshret🛒
\tRozhana 2$ 7aftana 5$ Mangana 15$🤝
\tBo kren Nama Bnern Bo TG @malashafiq 📱
\t{m}${k}${h}${sir} Author By : MALA SHAFIQ & BLND{x}{m}${k}${h}${x}''')
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	print(f'>>>>> {m}${k}${h}${x} Crack Daste Pekrd😈 {m}${k}${h}${x} <<<<< ')
	print('')
	print(f'')
